        ...
        <CardContent className="pt-0">
          <div className="rounded-md border border-[#94A3B8]/20">
            <Table>
              <TableHeader>
                <TableRow>
                  <TableHead className="text-xs font-medium text-[#94A3B8] uppercase tracking-wide">Cliente</TableHead>
                  <TableHead className="text-xs font-medium text-[#94A3B8] uppercase tracking-wide">Teléfono</TableHead>
                    ...
                    <TableCell className="text-right">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <Button
                          ...
                          className="h-8 w-8 p-0 text-[#1E40AF] hover:bg-[#1E40AF]/5 font-medium rounded-lg transition-all duration-150"
                        >
                          <MaterialIcon name="edit" className="text-base text-muted-foreground hover:text-foreground" />
                        </Button>
                        <Button
                          variant="ghost"
                          size="sm"
